<template>
  <div class="dashboard">
    ...
    <div class="menu-dropdown" :class="{ show: showMobileMenu }">
      <button class="add-btn" @click="addWidgetAndClose('chart')">+ Chart</button>
      <button class="add-btn" @click="addWidgetAndClose('image')">+ Image</button>
      <button class="add-btn" @click="addWidgetAndClose('data')">+ Data</button>
      <button class="add-btn" @click="addWidgetAndClose('iframe')">+ Embed</button>
      <button class="add-btn spotify-btn" @click="addWidgetAndClose('spotify')">+ Spotify</button>
      <button class="add-btn datetime-btn" @click="addWidgetAndClose('datetime')">+ Clock</button>
      <button class="add-btn oblique-btn" @click="addWidgetAndClose('oblique')">+ Oblique</button>
      <div class="menu-divider"></div>
      <button class="reset-btn" @click="resetAndClose">Reset Layout</button>
    </div>
