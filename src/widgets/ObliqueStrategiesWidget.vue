<template>
  <div class="oblique-widget">
    <div class="card-container">
      ...
      <button v-if="isFlipped" class="draw-btn" title="Draw new card" @click="drawNewCard">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
      ...
      <button v-else class="draw-btn" title="Draw a card" @click="drawCard">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
    ...
    <div class="attribution">Oblique Strategies by Brian Eno & Peter Schmidt</div>
  </div>
</template>
