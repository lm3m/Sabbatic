<template>
  <div class="spotify-widget">
    ...
    <div v-if="!hasCredentials" class="setup-screen">
      ...
      <p class="setup-info">
        Enter your Spotify API credentials to view your currently playing track.
      </p>
      ...
      <button class="connect-btn" :disabled="!clientId || !clientSecret" @click="saveAndConnect">
        Save & Connect
      </button>
    ...
    <div v-else-if="!isAuthenticated && !authError" class="auth-screen">
      ...
      <button class="connect-btn" @click="startAuth">Authorize</button>
      <button class="reset-btn" @click="resetCredentials">Change Credentials</button>
    </div>
    ...
    <div v-else-if="authError" class="error-screen">
      ...
      <p>{{ authError }}</p>
      <button class="connect-btn" @click="startAuth">Try Again</button>
      <button class="reset-btn" @click="resetCredentials">Reset Credentials</button>
    </div>
    ...
    <div v-else-if="isAuthenticated" class="now-playing">
      ...
      <div v-else-if="currentTrack" class="track-info">
        ...
        <div class="playback-controls">
          ...
          <button class="control-btn" :disabled="controlsLoading" title="Next" @click="handleNext">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <button class="settings-btn" title="Settings" @click="resetCredentials">
        <svg
          width="14"
          height="14"
          viewBox="0 0 24 24"
