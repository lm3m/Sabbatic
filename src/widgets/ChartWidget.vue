<template>
  <div class="chart-widget">
    ...
    <div v-else class="chart-container">
      ...
      <Doughnut v-else-if="config.chartType === 'doughnut'" :data="chartData" :options="doughnutOptions" />
  ...
  if (props.config.staticData) {
    return {
      ...
      datasets: [{
        ...
        backgroundColor: props.config.chartType === 'doughnut' || props.config.chartType === 'pie'
          ? chartColors
          : 'rgba(26, 115, 232, 0.6)',
        borderColor: props.config.chartType === 'doughnut' || props.config.chartType === 'pie'
